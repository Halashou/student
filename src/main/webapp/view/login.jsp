...
<script type="text/javascript">
	$(function(){
		...
		$("#vcodeImg").click(function(){
			this.src="${pageContext.request.contextPath}/login/getCode?t="+new Date().getTime();
		});
		
		//登录
		$("#submitBtn").click(function(){
			var data = $("#form").serialize(); //获取表单中的数据，并序列化
			console.log(data);
			$.ajax({
				type: "post",
				...
				success: function(msg){
					if("vcodeError" == msg){
						...
						window.location.href = "${pageContext.request.contextPath}/SystemServlet?method=toAdminView";
					} else{
						alert(msg);
					} 
				}
    ...
    <form id="form" class="form form-horizontal" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          ...
          <img title="点击图片切换验证码" id="vcodeImg" src="${pageContext.request.contextPath}/login/getCode"></div>
      </div>
...
<div class="footer">Copyright &nbsp; &copy; &nbsp; LiANG </div>
